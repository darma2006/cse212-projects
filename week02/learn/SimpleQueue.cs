public class SimpleQueue {
    public static void Run() {
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: Enqueue was inserting at the front of the list instead of adding to the back.
        ...
        // Defect(s) Found: No additional defects. Exception handling worked correctly.
    }
